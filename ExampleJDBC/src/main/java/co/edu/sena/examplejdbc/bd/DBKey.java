...
public class DBKey extends BDConnection{
        ...
        public void update (Key key)
    {
            try {
                ...
                MessageUtils.showErrorMessage("Error al actuallizar el tipo de llave  " + e.getMessage());
            }finally{
                disconnect();
            }
    }
        public void delete (int id)
    {
            try {
                ...
                MessageUtils.showErrorMessage("Error al eliminar el tipo de llave  " + e.getMessage());
            }finally{
                disconnect();
            }
    }
        ...
        public Key findById(int id)
    {
        ...
        try {
            ...
            MessageUtils.showErrorMessage("Error al consultar los tipos de llaves " + e.getMessage());
        }finally{
            disconnect();
        }
        return key;
